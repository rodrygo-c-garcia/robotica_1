  // pin analogico
  int potenciometro = 0; // pin analogico del A0
  // pines PWM
  ...
  void setup() {
    ...
    pinMode(potenciometro, INPUT); // pin analogico, se sobreentiende que es entrada siempre
  ...
  void loop() {
    ...
    value = analogRead(potenciometro); // para leer el pin analogo, para recibir señal, retorna valores entre 0 - 1023
